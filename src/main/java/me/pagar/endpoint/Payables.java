...
public class Payables {
	...
	public ArrayList<PayableResponse> save(Transaction request, PayableRequest payable) throws HttpException, IOException, ParserException {
		return this.endpointCommons.findAllThrough("/transactions", request, "/payables", payable);
	}
}
